...
function main() {
  ...
  check("list shows 리포트최종 action", /리포트최종/.test(read("components/report/admin/AdminCaseRowActions.tsx")));
  check("list shows 공문 action", />\s*공문\s*</.test(read("components/report/admin/AdminCaseRowActions.tsx")) || /        공문/.test(read("components/report/admin/AdminCaseRowActions.tsx")));
