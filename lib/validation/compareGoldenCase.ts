...
function buildReportText(report: ScanReport, audience: AudienceReport): string {
  return [
    ...
    audience.safetyType.whyProblem,
    audience.safetyType.legalOrLimitTitle,
    audience.safetyType.legalOrLimitBody,
    audience.safetyType.howToAct,
    ...
    audience.safetyType.diagnosisMethodLabel,
    audience.safetyType.fileNameLabel ?? "",
    audience.safetyType.reportOrInquireLabel,
    ...audience.userEvidenceCards.flatMap((card) => [
      card.title,
      card.fact,
      card.whyProblem,
      card.action,
