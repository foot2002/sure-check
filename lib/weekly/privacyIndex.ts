...
export const WEEKLY_PRIVACY_INDEX_FORMULA = {
  title: "개인정보 보호 수준지수 산정 방식",
  intro:
    "개별 설문 점수는 개인정보 수집 정보의 민감도, 고지 항목 충족 여부, 외부도구·처리경로 확인 필요 여부 등을 종합해 100점 기준으로 환산합니다. 주간 지수는 분석 가능한 진단 완료 설문 점수의 평균입니다.",
  steps: [
...
export const WEEKLY_PRIVACY_GRADE_BANDS: Array<{
...
}> = [
  {
    ...
    max: 100,
    meaning:
      "공개 화면에서 기본 고지·안내가 비교적 확인되는 구간입니다. 자동진단 기반 참고 지표입니다.",
  },
  {
    grade: "보통",
    range: "60~79점",
